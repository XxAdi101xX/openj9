...
public:
	...
	{
		jdouble *adouble = reinterpret_cast<jdouble*>(a);
		jdouble *bdouble = reinterpret_cast<jdouble*>(b);
		bool result = false;
	...
	{
		jfloat afloat, bfloat;
		PTR_SINGLE_VALUE(reinterpret_cast<jdouble*>(a), &afloat);
		PTR_SINGLE_VALUE(reinterpret_cast<jdouble*>(b), &bfloat);
		bool result = false;
